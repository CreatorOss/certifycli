...
# Demo script untuk menunjukkan CertifyCLI Local Mode
echo "🏠 CertifyCLI Local Mode Demo"
echo "============================"

echo "📋 This demo shows the serverless local mode features:"
...
if ! command -v go &> /dev/null; then
    echo "❌ Go is not installed. Please install Go to see this demo."
...
echo ""
echo "💡 Next Steps:"
echo "1. Run './test-local-mode.sh' for comprehensive testing"
echo "2. Try 'certifycli setup' to create your local identity"
